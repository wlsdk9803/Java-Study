...
public class LocalDateTimeMain {
    public static void main(String[] args) {
        ...
        System.out.println("현재 날짜 시간과 지정 날짜 시간이 같은가? " + nowDt.isEqual(ofDt)); // equals() 쓰면 안됨. isEquals() 써야 됨!
        // isEqual()는 단순히 비교 대상이 시간적으로 같으면 true를 반환
        // equals()는 객체의 타입, 타임존 등등 내부 데이터의 모든 구성요소가 같아야 true를 반환
    }
}
